    ...
    <div className="lg:block hidden w-full h-[58px] bg-[#23856D]">
      <div className="flex justify-between items-center w-full h-full px-[24px]">
        ...
        <div className="flex gap-[10px] items-center">
          ...
          <div className="flex gap-[10px]">
            <Link href="https://www.linkedin.com/in/syeda-dua-zehra-6067252b6/">
            <Image src={insta} alt="Instagram" width={30} height={20} /></Link>
            <Link href="https://www.linkedin.com/in/syeda-dua-zehra-6067252b6/">
            <Image src={yout} alt="YouTube" width={30} height={20} />
            </Link>
            <Link href="https://www.linkedin.com/in/syeda-dua-zehra-6067252b6/">
            <Image src={fb} alt="Facebook" width={30} height={20} />
            </Link>
            <Link href="https://www.linkedin.com/in/syeda-dua-zehra-6067252b6/">
            <Image src={twit} alt="Twitter" width={30} height={20} />
            </Link>
          </div>
        </div>
      </div>
